                ...
                <div class="panel-body">
                	...
                	<div class="col-sm-8 col-sm-offset-2">
                		...
                		<div class="wrap" id="seatshow">
		                	...
		                	<label class="label label-danger col-sm-1"><h5> A1 <br><input type="checkbox" name="seatsel1" value="A1"></h5></label>
		                	<label class="label label-danger col-sm-1"><h5> A2 <br><input type="checkbox" name="seatsel2" value="A2"></h5></label>
		                	<label class="label label-danger col-sm-1"><h5> A3 <br><input type="checkbox" name="seatsel3" value="A3"></h5></label>
		                	<label class="label label-danger col-sm-1"><h5> A4 <br><input type="checkbox" name="seatsel4" value="A4"></h5></label>
		                	<label class="label label-danger col-sm-1"><h5> A5 <br><input type="checkbox" name="seatsel5" value="A5"></h5></label>
		                	<label class="label label-danger col-sm-1"><h5> A6 <br><input type="checkbox" name="seatsel6" value="A6"></h5></label>
		                	<label class="label label-danger col-sm-1"><h5> A7 <br><input type="checkbox" name="seatsel7" value="A7"></h5></label>
		                	<label class="label label-danger col-sm-1"><h5> A8 <br><input type="checkbox" name="seatsel8" value="A8"></h5></label>
		                	<label class="label label-danger col-sm-1"><h5> A9 <br><input type="checkbox" name="seatsel9" value="A9"></h5></label>
		                	<label class="label label-danger col-sm-1"><h5> A10 <br><input type="checkbox" name="seatsel10" value="A10"></h5></label>
